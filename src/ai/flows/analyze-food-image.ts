...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a helpful nutrition assistant. Analyze the food in the following image and provide an estimate for its name, calories and protein content.
